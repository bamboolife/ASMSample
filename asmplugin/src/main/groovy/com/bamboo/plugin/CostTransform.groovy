...
//                        }
    ...
    static boolean shouldProcessClass(String classFilePath) {
        return classFilePath != null && classFilePath.startsWith("com/bamboo/sample")
    }
...
//            }
    ...
    static class CostAdviceAdapter extends AdviceAdapter {
        ...
        AnnotationVisitor visitAnnotation(String desc, boolean visible) {
            if ("Lcom/bamboo/sample/Cost;" == desc) {
//            if (Type.getDescriptor(Cost) == desc) {
        ...
        protected void onMethodEnter() {
            if (inject) {
                ...
                mv.visitMethodInsn(INVOKESTATIC, "com/bamboo/sample/TimeCache", "setStartTime", "(Ljava/lang/String;J)V", false)
            }
        }
        ...
        protected void onMethodExit(int opcode) {
            if (inject) {
                mv.visitLdcInsn(methodName)
                mv.visitMethodInsn(INVOKESTATIC, "java/lang/System", "nanoTime", "()J", false)
                mv.visitMethodInsn(INVOKESTATIC, "com/bamboo/sample/TimeCache", "setEndTime", "(Ljava/lang/String;J)V", false)
                mv.visitFieldInsn(GETSTATIC, "java/lang/System", "out", "Ljava/io/PrintStream;")
                mv.visitLdcInsn(methodName)
                mv.visitMethodInsn(INVOKESTATIC, "com/bamboo/sample/TimeCache", "getCostTime", "(Ljava/lang/String;)Ljava/lang/String;", false)
                mv.visitMethodInsn(INVOKEVIRTUAL, "java/io/PrintStream", "println", "(Ljava/lang/String;)V", false)
                mv.visitFieldInsn(GETSTATIC, "java/lang/System", "out", "Ljava/io/PrintStream;")
                mv.visitLdcInsn("========end=========")
                mv.visitMethodInsn(INVOKEVIRTUAL, "java/io/PrintStream", "println", "(Ljava/lang/String;)V", false)
